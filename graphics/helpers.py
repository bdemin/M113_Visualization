...
def set_actor_visuals(actor, _type):
    Chassis = {'color':(0.244, 0.275, 0.075), 'ambi':0.1, 'ambic':(0.2,0.2,0.2), 'diff':0.9, 'diffc':(0.2, 0.2, 0.1), 'spec':0.4, 'specp':10}
    ...
    Track_Unit = {'color':(0.35,0.35,0.35), 'ambi':0.3, 'ambic':(0,0,0), 'diff':0.4, 'diffc':(0.1, 0.1, 0.1), 'spec':0, 'specp':0}
    Trailing_Arm = {'color':(0.35,0.35,0.35), 'ambi':0.3, 'ambic':(0,0,0), 'diff':0.4, 'diffc':(0.1, 0.1, 0.1), 'spec':0, 'specp':0}
    _type = vars()[_type]
